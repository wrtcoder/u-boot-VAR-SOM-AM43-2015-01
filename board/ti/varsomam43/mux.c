...
static struct module_pin_mux mmc1_pin_mux[] = {
	{OFFSET(gpmc_csn1), (MODE(2) | PULLUDDIS | RXACTIVE)}, //mmc0_clk
	{OFFSET(gpmc_csn2), (MODE(2) | PULLUP_EN | RXACTIVE)}, //mmc0_cmd
	{OFFSET(gpmc_ad8), (MODE(2) | PULLUP_EN | RXACTIVE)},//mmc0_dat0
	{OFFSET(gpmc_ad9), (MODE(2) | PULLUP_EN | RXACTIVE)},//mmc0_dat1
	{OFFSET(gpmc_ad10), (MODE(2) | PULLUP_EN | RXACTIVE)},//mmc0_dat2
	{OFFSET(gpmc_ad11), (MODE(2) | PULLUP_EN | RXACTIVE)},//mmc0_dat3
	{-1},
};
