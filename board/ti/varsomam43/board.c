...
void board_varsomam43_phy1_enable(void)
{
       unsigned int temp;
...
#define PRCM_CM_CLKOUT1_CTRL_REG_ADDR	0x44df4100
#define PRCM_CM_DLL_CTRL_REG_ADDR	0x44df4104
#define PRCM_CM_CLKOUT2_CTRL_REG_ADDR	0x44df4108

#define CLKOUT2_REG_ADDR 0x44E10a74

void board_varsomam43_32KHz_clkout2_enable(void)
{
	/* Enable CLKOUT2 */
	writel(0x01800000, PRCM_CM_CLKOUT1_CTRL_REG_ADDR);
	writel(0x00000004, PRCM_CM_DLL_CTRL_REG_ADDR);
	writel(0x00010000, PRCM_CM_CLKOUT2_CTRL_REG_ADDR);

	/*Configure pinmux for CLKOUT2 */ 
	writel(0x00020003, CLKOUT2_REG_ADDR);
}
